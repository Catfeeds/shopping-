 ...
 * 课程发布中的第一步，选择课程分类
 */
var goods_category_quick = new Array();// 快速选择课程分类集合
$(function() {
...
//	var quick_id = "";// 所选择的课程分类
//	for (var i = 1; i < count; i++) {
//		var span = $(spanList[i]);
//		var html = span.html();
//		goods_category_name += html;
//		quick_id += span.attr("cid") + ",";// 记录用户所选择的课程类目Id，用与在快速选择课程类目中显示
//	}
...
//	// 判断当前所选择的课程分类与Cookie中的进行查询，是否存在，不存在则添加，
...
function GetProductCategoryData(categoryData) {
	...
	for (var i = 0; i < categoryData.length; i++) {
		...
		var attrId = cate["attr_id"];//关联课程类型ID
		var $rootCategory = "";
