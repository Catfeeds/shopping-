...
/**
 * 虚拟课程类型表
 * virtual_goods_type_id int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '虚拟课程类型id',
 * virtual_goods_group_id int(11) NOT NULL COMMENT '关联虚拟课程分组id',
 * virtual_goods_type_name varchar(255) NOT NULL COMMENT '虚拟课程类型名称',
 * validity_period int(11) NOT NULL DEFAULT 0 COMMENT '有效期/天(0表示不限制)',
 * is_enabled tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否启用（禁用后要查询关联的虚拟课程给予弹出确认提示框）',
