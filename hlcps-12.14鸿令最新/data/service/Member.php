...
class Member extends User implements IMember
{
     ...
     */
    public function registerMember($user_name, $password, $email, $mobile, $user_qq_id, $qq_info, $wx_openid, $wx_info, $wx_unionid,$pid=0)
    {
        // if (! empty($user_name)) {
     ...
     * PC端扫码登录
     */
    public function usreLogin($user_name,$password)
    {
        // 直接登录
