...
class WxPayUnifiedOrder extends WxPayDataBase
{
    ...
    /**
     * 设置课程标记，代金券或立减优惠功能的参数，说明详见代金券或立减优惠
     * @param string $value
     **/
    ...
    /**
     * 获取课程标记，代金券或立减优惠功能的参数，说明详见代金券或立减优惠的值
     * @return 值
     **/
    ...
    /**
     * 判断课程标记，代金券或立减优惠功能的参数，说明详见代金券或立减优惠是否存在
     * @return true 或 false
     **/
    ...
    /**
     * 设置trade_type=NATIVE，此参数必传。此id为二维码中包含的课程ID，商户自行定义。
     * @param string $value
     **/
    ...
    /**
     * 获取trade_type=NATIVE，此参数必传。此id为二维码中包含的课程ID，商户自行定义。的值
     * @return 值
     **/
    ...
    /**
     * 判断trade_type=NATIVE，此参数必传。此id为二维码中包含的课程ID，商户自行定义。是否存在
     * @return true 或 false
     **/
