...
class Niu extends TagLib
{
    ...
    protected $tags = [
        ...
        'goodsviewlist'       => ['attr' => 'page,num,where,order,field,cache,name', 'close' => 1],//直接查询课程列表
        'memberhistory'       => ['attr' => 'cache,name', 'close' => 1],//会员浏览历史
        'memberlikes'         => ['attr' => 'cache,name', 'close' => 1],//猜你喜欢
        
        
        
        'goodsinfo'           => ['attr' => 'id,cache,name', 'close' => 1],//课程详情
        ...
        //首页活动课程
        'recommendgoodslist'  => ['attr' => 'name,cache','close'=>1],//首页促销课程
        'discountgoodslist'   => ['attr' => 'page,num,where,order,name,cache','close'=>1],//首页限时折扣课程列表
		...
		'goodscoupon'         => ['attr' =>'goods_id,uid,name,cache','close'=>1],//课程优惠券
		...
		'formatcategorylist'  => ['attr' => 'name,cache','close'=>1],//获取格式化后的课程分类
		'isfavorites'         => ['attr' => 'uid,goods_id,name,cache','close'=>1],//是否收藏了该课程
        ...
        //拼团
        'goodspellinglist' =>['attr'=>'name,page,num,where,field, order, cache','close'=>1],//课程拼单列表
        'gettuangougoodslist' =>['attr'=>'page,num,where,field,order,cache,name','close'=>1],//拼团课程列表
        'gettuangoudetail' =>['attr'=>'name,cache,where','close'=>1]//拼团课程列表
    ];
...
//     }
    ...
    /**
     *查询点赞记录表，获取详情再判断当天该店铺下该课程该会员是否已点赞
     */
