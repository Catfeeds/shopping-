...
return [
    ...
    'view_replace_str' => array(
        ...
        // 上传文件路径
        'UPLOAD_GOODS' => UPLOAD . '/goods/', // 存放课程图片主图
        'UPLOAD_GOODS_SKU' => UPLOAD . '/goods_sku/', // 存放课程sku图片
        'UPLOAD_GOODS_BRAND' => UPLOAD . '/goods_brand/', // 存放课程品牌图
        'UPLOAD_GOODS_GROUP' => UPLOAD . '/goods_group/', // 存放课程分组图片
        'UPLOAD_GOODS_CATEGORY' => UPLOAD . '/goods_category/', // 存放课程分组图片
