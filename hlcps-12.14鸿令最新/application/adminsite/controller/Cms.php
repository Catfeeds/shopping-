...
class Cms extends BaseController
{
    ...
    public function addArticle()
    {
        ...
        if (request()->isAjax()) {
            ...
            $status = 2;
            $result = $article->addArticle($title, $class_id, $short_title, $source, $url, $author, $summary, $content, $image, $keyword, $article_id_array, $click, $sort, $commend_flag, $comment_flag, $comment_examine, $status, $attachment_path, $tag, $comment_count, $share_count,$category,$category_name,$phone);
    ...
    public function ajax_updateArticle()
    {
        ...
        $status = 2;
        $article = new Article();
        $result = $article->updateArticle($article_id, $title, $class_id, $short_title, $source, $url, $author, $summary, $content, $image, $keyword, $article_id_array, $click, $sort, $commend_flag, $comment_flag, $comment_examine, $status, $attachment_path, $tag, $comment_count, $share_count,$category,$category_name,$phone);
        return AjaxReturn($result);
    }
