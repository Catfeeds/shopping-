...
class Index extends BaseController
{
    ...
    public function getGoodsCount()
    {
        ...
        // 回收站
        $GoodsDeleted = new NsGoodsDeletedModel();
        $goods_count_array['audit'] = $GoodsDeleted->getCount(['goods_kind'=>1]);
        //库已下架
    ...
    /**
     * 获取 已完成  未完成  取消订单中  取消订单申请不通过  取消订单已拒绝  已关闭
     */
