...
class BaseController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if($admin_id!=ADMINID){
            ...
            //删除数据库管理栏目
            unset($_SESSION['niu']['module_list']['module_list_218'][1]);
            //删除网站-搜索
            ...
            //删除会员-会员提现
            unset($_SESSION['niu']['module_list']['module_list_137'][2]);
            //删除会员-余额管理
            unset($_SESSION['niu']['module_list']['module_list_137'][3]);
            //删除微信栏目
            unset($_SESSION['niu']['module_list']['module_list_0'][7]);
            //删除网站栏目
            unset($_SESSION['niu']['module_list']['module_list_0'][8]);*/
            //删除缓存
