 ...
 * 返回值格式
 */
// 定义返回值字母格式 基础1000-1999， 用户：2000-2999 课程：3000-3999， 订单：4000-4999 活动：5000-5999
// 基础变量定义
...
function getErrorInfo($error_code)
{
    $system_error_arr = array(
        ...
        ACTIVE_REPRET => '在同一时间段内存在相同课程的活动！',
        GOODS_HAVE_BEEN_GIFT => '该课程已经是赠品了！',
        ...
        VIRIUAL_GOODS_TIME_ERROR=>'虚拟课程已过期或已使用！',
        VIRIUAL_GOODS_ERROR=>'虚拟课程已不能使用！',
